...
public class Register_2_MultipleBrowser extends BaseTest {
	...
	public void beforeClass(String browserName) {
		// driver của testcase phải gọi tới driver của trình duyệt thì mới chạy được
		// nếu không gán thì driver bị null không chạy được
